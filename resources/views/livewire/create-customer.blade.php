                ...
                <div class="modal-body pb-3 px-sm-3" wire:ignore.self>
                    ...
                    <div class="bs-stepper vertical wizard-modern create-app-wizard" wire:ignore.self>
                        ...
                        <div class="bs-stepper-header" role="tablist" wire:ignore.self>
                            ...
                            <div class="step first-step second-prev" role="tab" wire:ignore.self>
                                <button type="button" class="step-trigger py-75" wire:ignore.self>
                                    <span
                                        class="bs-stepper-box
                                    @if ($errors->has('name') || $errors->has('phone') || $errors->has('email') || $errors->has('identification_number')) bg-danger @endif
                                        ">
                                        <span wire:ignore>
                                    ...
                                    <span class="bs-stepper-label" wire:ignore.self>
                                        <span
                                            class="bs-stepper-title @if ($errors->has('name') || $errors->has('phone') || $errors->has('email') || $errors->has('identification_number')) text-danger @endif">
                            ...
                            <div class="step second-step first-next" role="tab" wire:ignore.self>
                                <button type="button" class="step-trigger py-75" wire:ignore.self>
                                    <span
                                        class="bs-stepper-box
                            ...
                            <div class="step third-step second-next" role="tab" wire:ignore.self>
                                <button type="button" class="step-trigger py-75" wire:ignore.self>
                                    <span
                                        class="bs-stepper-box
                                        @if (
                        ...
                        <div class="bs-stepper-content shadow-none" wire:ignore.self>
                            ...
                            <div class="personal-first" style="display: block;" wire:ignore.self role="tabpanel">
                            ...
                            <div class="personal-second" style="display: none;" role="tabpanel" wire:ignore.self>
                                ...
                                <div class="d-flex justify-content-between mt-2">
                                    <button class="btn btn-primary btn-prev second-prev">
                                        <i data-feather="arrow-left" class="align-middle me-sm-25 me-0"></i>
                                        <span class="align-middle d-sm-inline-block d-none">السابق</span>
                                    </button>
                            ...
                            <div class="personal-third" style="display: none;" role="tabpanel" wire:ignore.self>
    ...
    @push('order-create')
        <script>
            ...
            $(document).ready(function() {
                ...
                var first = $(".personal-first");
                var second = $(".personal-second");
                var third = $(".personal-third");
